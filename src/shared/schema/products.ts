...
export const skuDetailsSchemma = SchemaFactory.createForClass(SkuDetails);
@Schema({ timestamps: true })
...
export const ProductShema = SchemaFactory.createForClass(Products);
